...
|---|---|---|---|---|---|
| [1](https://github.com/jizhi0v0/macos27-beta-issues/issues/1) | [CoreMedia `fpSupport_GetVideoRange…` loop floods logd](issues/apple-coremedia-fpsupport-logd-spam.md) | Apple MediaToolbox / CoreMedia | 🟡 | quit the WebKit apps / silence subsystem log | **[FB23411581](https://feedbackassistant.apple.com/feedback/23411581)** |
| [2](https://github.com/jizhi0v0/macos27-beta-issues/issues/2) | [Shortcuts/Siri ToolKit action-registration storm](issues/apple-shortcuts-siri-toolkit-storm.md) | Apple Shortcuts / siriactionsd | 🟡 | self-settles post-boot; silence subsystem log | Feedback: `FB________` |
