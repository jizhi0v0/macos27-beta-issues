...
| 3 | [WindowServer high CPU + `Invalid window` SkyLight loop](issues/apple-windowserver-invalid-window.md) | Apple WindowServer / SkyLight | ⚪ | Reduce transparency/motion; restart offending app | Feedback: `FB________` |
| 4 | [Weather.app VFX thread spins ~36% CPU in background](issues/apple-weather-vfx-cpu-spin.md) | Apple Weather.app 6.0 | 🟡 | `killall Weather`; don't background it | Feedback: `FB________` |
