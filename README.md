...
| 14 | [Click/input latency = event delivery delayed under load (not the app)](issues/apple-click-input-latency-beta.md) | macOS 27 event delivery under load | 🔵 explained: downstream of #1/#12/#13 + WindowServer load (fine on 26) | reduce load / fix the filed CPU bugs | symptom, not a separate bug |
