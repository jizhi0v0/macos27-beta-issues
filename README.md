...
| [12](https://github.com/jizhi0v0/macos27-beta-issues/issues/12) | [MenuBarAgent ~10–14% CPU at idle (static menu bar)](issues/apple-menubaragent-idle-cpu.md) | Apple MenuBarAgent | ⚪ **needs retest on `26A5378n`** — fixed verdict was measured on `…j` only; an external report ([#20](https://github.com/jizhi0v0/macos27-beta-issues/issues/20)) claims it is not fixed on that same `…j` | (was) none | **[FB23411741](https://feedbackassistant.apple.com/feedback/23411741)** |
